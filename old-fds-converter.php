<?php
	// ----- function timestamp -> Note: solve format like (example "Thu27Mar")
	...
	// ERASE DATA
	$query = "TRUNCATE TABLE old_fds"; if (!mysql_query($query)) die(mysql_error());
